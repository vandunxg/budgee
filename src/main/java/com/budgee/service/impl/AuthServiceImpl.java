...
public class AuthServiceImpl implements AuthService {
    ...
    public TokenResponse getAccessToken(LoginRequest request) throws AccessDeniedException {
        ...
        try {
            ...
            log.debug("authenticated={}, authorities={}", authentication.isAuthenticated(), authentication.getAuthorities());
        } catch (AuthenticationException ex) {
            log.warn("authentication failed email_fingerprint={}, reason={}", fingerprint(email), ex.getClass().getSimpleName());
    ...
    public TokenResponse getRefreshToken(String refreshToken) throws AccessDeniedException {
        ...
        try {
            ...
            log.warn("refresh token invalid fp={}, reason={}", fingerprint(refreshToken), ex.getClass().getSimpleName());
